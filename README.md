...
| `textStyle`           | Add Custom styles for styling the `text` value.                    | `null`    | `string`                   | 
...
| `innerShadowStyle` | Add Custom styles for progress circle inside shadow.                                                                                        | `null`                                            | `string`              |
| `outerShadowStyle` | Add Custom styles for progress circle outside shadow.                                                                                       | `null`                                            | `string`              |
| `PercentageStyle`  | Add Custom styles for percentage value.                                                                                                     | `null`                                            | `string`              |
